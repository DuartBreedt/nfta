<?php
	...
	function getUserDogs() {
		...
		while ($stmt->fetch()) {
			$retStr .= "<li class='list-custom-item list-group-item'><a href='viewDog.php?id=".$dogid."'><p><span>NAME: </span> ".$name." <span>NICKNAME: </span> ".$nickname." <span>SEX: </span> ".$sex." <span>BREED: </span> ".$breed."</p></a></li>";
