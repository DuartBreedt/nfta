...
<html lang="en">
    ...
    <body data-club="bftc">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="club-banner col-xs-12 col-sm-12 col-md-12 col-lg-12"">
                    <div class="banner col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="banner-logo col-xs-3 col-sm-2 col-md-1 col-lg-1">
                            <img src="images/club-logos/bftc.png" alt="logo image"/>
                        </div>
                        <div class="banner-title col-xs-9 col-sm-10 col-lg-11 col-md-11">
                            <h1>Border Field Trial Club</h1>
                        </div>
                    </div>
                    <img src="images/banners/bftc.jpg" alt="WCFTC image"/>
                </div>
            </div>
                ...
                <nav class="navbar navbar-default">
                    <div class="container-fluid">
                        <ul class="nav navbar-nav">
                            <li class="active"><a href="bftc.php" id="home-link">Club Home</a></li>
            ...
            <div class="row club-main club-events"><?php echo getEventsOfClub("bftc"); ?></div>
            <div class="row club-main club-galleries"> <?php echo getGalleriesOfClub("bftc"); ?></div>
            <div class="row club-main club-members"><?php echo getMembersOfClub("bftc"); ?></div>
